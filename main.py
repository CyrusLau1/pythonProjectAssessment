        ...
        try:
            ...
            if weekly_num_bf == 6 or weekly_num_bf == 7:
                ...
                print("Did you know that breakfast is often considered the most important meal "
                      ...
                      "start the day off right, \nso make sure to continue eating breakfast every day to increase "
                      "your productivity!")
            elif 5 >= weekly_num_bf > 0:
                print(f"That's not too good... You are only eating breakfast {weekly_num_bf} times a week.")
                print(
                    f"As a {age} year old teenager, you should try to eat breakfast every day as it is often considered"
                    " the most important meal of the day. \nBreakfast provides your body and brain with the necessary "
                    "fuel and nutrients to start the day off right, which increases your productivity. \nIf you "
                    "really really need to skip breakfast, aim to make up for the nutritional content you missed at "
                    "breakfast with your lunch and dinner.")
            elif weekly_num_bf == 0:
                print("You never eat breakfast?! That's super unhealthy!")
                print(
                    f"As a {age} year old teenager, you should try to eat breakfast every day as it is often considered"
                    " the most important meal of the day! \nBreakfast provides your body and brain with the necessary "
                    "fuel and nutrients to start the day off right. \nMake sure to start eating breakfast tomorrow as "
                    "skipping breakfast has many negative effects on your body, which may decrease your productivity.")
            elif weekly_num_bf > 7 or weekly_num_bf < 0:
                print("There are 7 days in a week! Enter a number between 0 and 7.")
                foc_breakfast()
            print(
                "Remember: A healthy breakfast may contain some of these: eggs, protein pancakes, oatmeal, cereal & "
                "milk, fruits, \ngreek yoghurt, whole wheat bread, nuts, or anything else that is high in nutrition. "
                "\nTry to plan an exciting breakfast yourself so that you can look forward to it.")
            print("------------------------------")
        ...
        try:
            ...
            if 8 <= hours_slept <= 10:
                print(f"So you sleep {hours_slept} hours every night. You must be really healthy! "
                      ...
                      "and development. \nBy getting enough sleep, you can enhance your physical health, mental "
                      "health, athletic, \nsocial life, and even your academic performance! That's why sleep is "
                      "important for productivity.")
            elif 5 <= hours_slept <= 7:
                print(f"You only sleep {hours_slept} hours every night? That's not too good... "
                      f"\nFor a {age} year old teenager, 8-10 hours of sleep is a must in order to enable your "
                ...
                print(f"That's horrendous! {hours_slept} hours of sleep is too little!"
                      f"\nFor a {age} year old teenager, 8-10 hours of sleep is a must in order to enable your growth "
                      "and development. \nBy getting enough sleep, you can enhance your physical health, mental "
                      "health, athletic performance, social life, and even your academic performance. \nMake sure to "
                      "sleep more if you want to increase your productivity.")
            elif 24 >= hours_slept > 10:
                print(
                    "It's okay to sleep more than 10 hours occasionally, however, if you do this every day, it may "
                    "increase \nyour risk of getting illnesses and make you feel lethargic throughout the day. "
                    "\nAs a {age} year old teenager, you should aim for 8-10 hours of sleep in order to maximize "
                    "productivity.")
            elif 0 > hours_slept or hours_slept > 24:
                print("There are 24 hours in a day! Enter a number between 0 and 24.")
                foc_sleep()
            print(
                "Remember:  It's important to find a healthy balance and aim for the optimal amount of sleep for "
        ...
        try:
            ...
            if 50 > tidy_up_freq >= 3:
                print(f"If you tidy your room {tidy_up_freq} times a month, your room must be very clean! "
                      ...
                      "and dust particles. \nWhat's more, it also prevents bacteria and viruses from harboring in your"
                      " home. \nWith clear and fresh air, your sleep will be better and healthier, and your "
                ...
                print(
                    "How many times do you clean your room every day?!?! It's good to be clean, but that's too much...")
            else:
                print("Please enter a positive number.")
                foc_tidy_up()
            print(
                "Remember, making your bed every morning can help you sleep better at night, so make sure you do that, "
                "too!")
            print("------------------------------")
            # Ask whether the user would like to continue using the tool
            while True:
...
def foc_work_out():
    ...
    while True:
        try:
            ...
            if 1440 >= workout_time >= 150:
                print("You must be really fit if you work out around {:.1f} minutes every day! "
                      ...
                      .format(workout_time / 7))
            elif 50 <= workout_time < 150:
                print(
                    f"{workout_time} minutes of exercise per week isn't ideal unless you are doing high intensity "
                    f"workouts."
                    "\nRegular exercise can increase your energy levels and reduce fatigue, making it easier to "
                    "perform daily tasks, thus increasing your productivity. \nSo make sure you work out more!")
            elif 0 <= workout_time < 50:
                print(
                    f"{workout_time} minutes of exercise per week is too little! A sedentary lifestyle can cause "
                    "fatigue and reduced energy levels, making it harder to perform daily activities, thus decreasing "
